---
page_title: "management-v1 Provider"
---

# management-v1 Provider

This provider is used to interact with the resources provided by the **management-v1** application of the [Nokia EDA](https://docs.eda.dev) platform.
