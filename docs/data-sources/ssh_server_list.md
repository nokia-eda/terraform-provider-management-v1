...
page_title: "management-v1_ssh_server_list Data Source - management-v1"
subcategory: ""
description: |-
  
---

# management-v1_ssh_server_list (Data Source)
...
- `down_servers` (Attributes List) List of down SSH servers. (see [below for nested schema](#nestedatt--items--status--down_servers))
- `health` (Number) Health score of the SSH server.
- `health_score_reason` (String) Reason for the health score.
- `last_change_time` (String) Indicates when the SSH server last changed state.
