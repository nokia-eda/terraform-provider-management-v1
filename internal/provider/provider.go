...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-management/internal/eda/utils"
...
var _ provider.Provider = (*managementProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &managementProvider{version: ver}
	}
}
...
func (p *managementProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *managementProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *managementProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "management-v1"
	resp.Version = p.version
}

func (p *managementProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewFtpServerDataSource,
		NewFtpServerListDataSource,
		NewGrpcServerDataSource,
		NewGrpcServerListDataSource,
...
func (p *managementProvider) Resources(ctx context.Context) []func() resource.Resource {
