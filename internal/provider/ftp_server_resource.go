...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-management/internal/resource_ftp_server"
	"github.com/nokia/eda/apps/terraform-provider-management/internal/tfutils"
)

const (
	create_rs_ftpServer = "/apps/management.eda.nokia.com/v1/namespaces/{namespace}/ftpservers"
	read_rs_ftpServer   = "/apps/management.eda.nokia.com/v1/namespaces/{namespace}/ftpservers/{name}"
	update_rs_ftpServer = "/apps/management.eda.nokia.com/v1/namespaces/{namespace}/ftpservers/{name}"
	delete_rs_ftpServer = "/apps/management.eda.nokia.com/v1/namespaces/{namespace}/ftpservers/{name}"
)

var (
	_ resource.Resource                = (*ftpServerResource)(nil)
	_ resource.ResourceWithConfigure   = (*ftpServerResource)(nil)
	_ resource.ResourceWithImportState = (*ftpServerResource)(nil)
)
...
func (r *ftpServerResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_ftpServer, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_ftpServer, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_ftpServer,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *ftpServerResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_ftpServer, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *ftpServerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_ftpServer, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
...
func (r *ftpServerResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
