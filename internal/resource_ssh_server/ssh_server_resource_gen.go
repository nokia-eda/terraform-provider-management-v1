...
func SshServerResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^SSHServer$"), ""),
				},
				Default: stringdefault.StaticString("SSHServer"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the SSHServer",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	enablePasswordAuthenticationAttribute, ok := attributes["enable_password_authentication"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`enable_password_authentication is missing from object`)

		return nil, diags
	}

	enablePasswordAuthenticationVal, ok := enablePasswordAuthenticationAttribute.(basetypes.BoolValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`enable_password_authentication expected to be basetypes.BoolValue, was: %T`, enablePasswordAuthenticationAttribute))
	}
	...
	return SpecValue{
		EnablePasswordAuthentication: enablePasswordAuthenticationVal,
		Enabled:                      enabledVal,
		Port:                         portVal,
		Router:                       routerVal,
...
type SpecValue struct {
	EnablePasswordAuthentication basetypes.BoolValue   `tfsdk:"enable_password_authentication"`
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["enable_password_authentication"] = basetypes.BoolType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.EnablePasswordAuthentication.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["enable_password_authentication"] = val
...
func (v SpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	if diags.HasError() {
		return types.ObjectUnknown(map[string]attr.Type{
			"enable_password_authentication": basetypes.BoolType{},
	...
	objVal, diags := types.ObjectValue(
		attributeTypes,
		map[string]attr.Value{
			"enable_password_authentication": v.EnablePasswordAuthentication,
			"enabled":                        v.Enabled,
			"port":                           v.Port,
			"router":                         v.Router,
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.EnablePasswordAuthentication.Equal(other.EnablePasswordAuthentication) {
		return false
	}
