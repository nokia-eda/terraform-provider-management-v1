...
func FtpServerResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^FTPServer$"), ""),
				},
				Default: stringdefault.StaticString("FTPServer"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the FTPServer",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"status": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"down_servers": schema.ListNestedAttribute{
						...
						MarkdownDescription: "List of down FTP servers.",
					},
					"health": schema.Int64Attribute{
						Optional:            true,
						Computed:            true,
						Description:         "Health score of the FTP server.",
						MarkdownDescription: "Health score of the FTP server.",
					},
					...
					"last_change_time": schema.StringAttribute{
						...
						MarkdownDescription: "Indicates when the FTP server last changed state.",
					},
					"operational_state": schema.StringAttribute{
						Optional:            true,
						Computed:            true,
						Description:         "Operational state of the FTP server.",
						MarkdownDescription: "Operational state of the FTP server.",
						Validators: []validator.String{
							stringvalidator.OneOf(
								"Up",
								"Down",
				...
				MarkdownDescription: "FTPServerStatus defines the observed state of FTPServer",
			},
		},
	}
}
