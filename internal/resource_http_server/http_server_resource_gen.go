...
func HttpServerResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^HTTPServer$"), ""),
				},
				Default: stringdefault.StaticString("HTTPServer"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the HTTPServer",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					...
					"enabled": schema.BoolAttribute{
						...
						MarkdownDescription: "Enable the HTTP API server.",
					},
					...
					"protocol": schema.StringAttribute{
						...
						MarkdownDescription: "Specifies the protocol to use.",
						Validators: []validator.String{
				...
				MarkdownDescription: "HTTPServerSpec defines the desired state of HTTPServer",
			},
			"status": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"down_servers": schema.ListNestedAttribute{
						...
						MarkdownDescription: "List of down HTTP servers.",
					},
					...
					"last_change_time": schema.StringAttribute{
						...
						MarkdownDescription: "Indicates when the HTTP server last changed state.",
					},
					"operational_state": schema.StringAttribute{
						Optional:            true,
						Computed:            true,
						Description:         "Operational state of the HTTP server.",
						MarkdownDescription: "Operational state of the HTTP server.",
						Validators: []validator.String{
							stringvalidator.OneOf(
								"Up",
								"Down",
				...
				MarkdownDescription: "HTTPServerStatus defines the observed state of HTTPServer",
			},
		},
	}
}
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	enableAuthenticationAttribute, ok := attributes["enable_authentication"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`enable_authentication is missing from object`)

		return nil, diags
	}

	enableAuthenticationVal, ok := enableAuthenticationAttribute.(basetypes.BoolValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`enable_authentication expected to be basetypes.BoolValue, was: %T`, enableAuthenticationAttribute))
	}
	...
	return SpecValue{
		EnableAuthentication: enableAuthenticationVal,
		Enabled:              enabledVal,
		Port:                 portVal,
...
type SpecValue struct {
	EnableAuthentication basetypes.BoolValue   `tfsdk:"enable_authentication"`
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["enable_authentication"] = basetypes.BoolType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.EnableAuthentication.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["enable_authentication"] = val
...
func (v SpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	if diags.HasError() {
		return types.ObjectUnknown(map[string]attr.Type{
			"enable_authentication": basetypes.BoolType{},
	...
	objVal, diags := types.ObjectValue(
		attributeTypes,
		map[string]attr.Value{
			"enable_authentication": v.EnableAuthentication,
			"enabled":               v.Enabled,
			"port":                  v.Port,
			"protocol":              v.Protocol,
			"router":                v.Router,
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.EnableAuthentication.Equal(other.EnableAuthentication) {
		return false
	}
