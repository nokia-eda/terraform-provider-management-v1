...
func GrpcServerResourceSchema(ctx context.Context) schema.Schema {
		...
		Attributes: map[string]schema.Attribute{
			...
			"api_version": schema.StringAttribute{
				...
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^management\\.eda\\.nokia\\.com/v1$"), ""),
				},
				Default: stringdefault.StaticString("management.eda.nokia.com/v1"),
			},
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^GRPCServer$"), ""),
				},
				Default: stringdefault.StaticString("GRPCServer"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the GRPCServer",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"status": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"down_servers": schema.ListNestedAttribute{
						...
						MarkdownDescription: "List of down GRPC servers.",
					},
					...
					"last_change_time": schema.StringAttribute{
						...
						MarkdownDescription: "Indicates when the gRPC server last changed state.",
					},
					"operational_state": schema.StringAttribute{
						Optional:            true,
						Computed:            true,
						Description:         "Operational state of the gRPC server.",
						MarkdownDescription: "Operational state of the gRPC server.",
						Validators: []validator.String{
							stringvalidator.OneOf(
								"Up",
								"Down",
					...
					"services": schema.ListAttribute{
						...
						MarkdownDescription: "Enabled services on the gRPC server.",
					},
				},
				...
				MarkdownDescription: "GRPCServerStatus defines the observed state of GRPCServer",
			},
		},
	}
}

type GrpcServerModel struct {
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	gnmiServerAttribute, ok := attributes["gnmi_server"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`gnmi_server is missing from object`)

		return nil, diags
	}

	gnmiServerVal, ok := gnmiServerAttribute.(basetypes.ObjectValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`gnmi_server expected to be basetypes.ObjectValue, was: %T`, gnmiServerAttribute))
	}
	...
	maxConcurrentStreamsAttribute, ok := attributes["max_concurrent_streams"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`max_concurrent_streams is missing from object`)

		return nil, diags
	}

	maxConcurrentStreamsVal, ok := maxConcurrentStreamsAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`max_concurrent_streams expected to be basetypes.Int64Value, was: %T`, maxConcurrentStreamsAttribute))
	}

	metadataAuthenticationAttribute, ok := attributes["metadata_authentication"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`metadata_authentication is missing from object`)

		return nil, diags
	}

	metadataAuthenticationVal, ok := metadataAuthenticationAttribute.(basetypes.BoolValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`metadata_authentication expected to be basetypes.BoolValue, was: %T`, metadataAuthenticationAttribute))
	}
	...
	rateLimitCallsPerMinuteAttribute, ok := attributes["rate_limit_calls_per_minute"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`rate_limit_calls_per_minute is missing from object`)

		return nil, diags
	}

	rateLimitCallsPerMinuteVal, ok := rateLimitCallsPerMinuteAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`rate_limit_calls_per_minute expected to be basetypes.Int64Value, was: %T`, rateLimitCallsPerMinuteAttribute))
	}
	...
	sessionLimitAttribute, ok := attributes["session_limit"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`session_limit is missing from object`)

		return nil, diags
	}

	sessionLimitVal, ok := sessionLimitAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`session_limit expected to be basetypes.Int64Value, was: %T`, sessionLimitAttribute))
	}

	tlsProfileAttribute, ok := attributes["tls_profile"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`tls_profile is missing from object`)

		return nil, diags
	}

	tlsProfileVal, ok := tlsProfileAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`tls_profile expected to be basetypes.StringValue, was: %T`, tlsProfileAttribute))
	}

	yangModelsAttribute, ok := attributes["yang_models"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`yang_models is missing from object`)

		return nil, diags
	}

	yangModelsVal, ok := yangModelsAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`yang_models expected to be basetypes.StringValue, was: %T`, yangModelsAttribute))
	}
	...
	return SpecValue{
		Enabled:                 enabledVal,
		GnmiServer:              gnmiServerVal,
		Insecure:                insecureVal,
		MaxConcurrentStreams:    maxConcurrentStreamsVal,
		MetadataAuthentication:  metadataAuthenticationVal,
		Port:                    portVal,
		RateLimitCallsPerMinute: rateLimitCallsPerMinuteVal,
		Router:                  routerVal,
		RouterKind:              routerKindVal,
		RouterSelectors:         routerSelectorsVal,
		Services:                servicesVal,
		SessionLimit:            sessionLimitVal,
		TlsProfile:              tlsProfileVal,
		YangModels:              yangModelsVal,
		state:                   attr.ValueStateKnown,
	}, diags
}
...
type SpecValue struct {
	...
	GnmiServer              basetypes.ObjectValue `tfsdk:"gnmi_server"`
	Insecure                basetypes.BoolValue   `tfsdk:"insecure"`
	MaxConcurrentStreams    basetypes.Int64Value  `tfsdk:"max_concurrent_streams"`
	MetadataAuthentication  basetypes.BoolValue   `tfsdk:"metadata_authentication"`
	Port                    basetypes.Int64Value  `tfsdk:"port"`
	RateLimitCallsPerMinute basetypes.Int64Value  `tfsdk:"rate_limit_calls_per_minute"`
	...
	SessionLimit            basetypes.Int64Value  `tfsdk:"session_limit"`
	TlsProfile              basetypes.StringValue `tfsdk:"tls_profile"`
	YangModels              basetypes.StringValue `tfsdk:"yang_models"`
	state                   attr.ValueState
}
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["gnmi_server"] = basetypes.ObjectType{
		AttrTypes: GnmiServerValue{}.AttributeTypes(ctx),
	}.TerraformType(ctx)
	attrTypes["insecure"] = basetypes.BoolType{}.TerraformType(ctx)
	attrTypes["max_concurrent_streams"] = basetypes.Int64Type{}.TerraformType(ctx)
	attrTypes["metadata_authentication"] = basetypes.BoolType{}.TerraformType(ctx)
	attrTypes["port"] = basetypes.Int64Type{}.TerraformType(ctx)
	attrTypes["rate_limit_calls_per_minute"] = basetypes.Int64Type{}.TerraformType(ctx)
	...
	attrTypes["session_limit"] = basetypes.Int64Type{}.TerraformType(ctx)
	attrTypes["tls_profile"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["yang_models"] = basetypes.StringType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.GnmiServer.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["gnmi_server"] = val
		...
		val, err = v.MaxConcurrentStreams.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["max_concurrent_streams"] = val

		val, err = v.MetadataAuthentication.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["metadata_authentication"] = val
		...
		val, err = v.RateLimitCallsPerMinute.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["rate_limit_calls_per_minute"] = val
		...
		val, err = v.SessionLimit.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["session_limit"] = val

		val, err = v.TlsProfile.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["tls_profile"] = val

		val, err = v.YangModels.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["yang_models"] = val
...
func (v SpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	var gnmiServer basetypes.ObjectValue

	if v.GnmiServer.IsNull() {
		gnmiServer = types.ObjectNull(
			GnmiServerValue{}.AttributeTypes(ctx),
		)
	}

	if v.GnmiServer.IsUnknown() {
		gnmiServer = types.ObjectUnknown(
			GnmiServerValue{}.AttributeTypes(ctx),
		)
	}

	if !v.GnmiServer.IsNull() && !v.GnmiServer.IsUnknown() {
		gnmiServer = types.ObjectValueMust(
			GnmiServerValue{}.AttributeTypes(ctx),
			v.GnmiServer.Attributes(),
		)
	}
	...
	if diags.HasError() {
		return types.ObjectUnknown(map[string]attr.Type{
			...
			"gnmi_server": basetypes.ObjectType{
				AttrTypes: GnmiServerValue{}.AttributeTypes(ctx),
			},
			"insecure":                    basetypes.BoolType{},
			"max_concurrent_streams":      basetypes.Int64Type{},
			"metadata_authentication":     basetypes.BoolType{},
			"port":                        basetypes.Int64Type{},
			"rate_limit_calls_per_minute": basetypes.Int64Type{},
			...
			"session_limit": basetypes.Int64Type{},
			"tls_profile":   basetypes.StringType{},
			"yang_models":   basetypes.StringType{},
		}), diags
	}
	...
	objVal, diags := types.ObjectValue(
		...
		map[string]attr.Value{
			...
			"insecure":                    v.Insecure,
			"max_concurrent_streams":      v.MaxConcurrentStreams,
			"metadata_authentication":     v.MetadataAuthentication,
			"port":                        v.Port,
			"rate_limit_calls_per_minute": v.RateLimitCallsPerMinute,
			"router":                      v.Router,
			"router_kind":                 v.RouterKind,
			"router_selectors":            routerSelectorsVal,
			"services":                    servicesVal,
			"session_limit":               v.SessionLimit,
			"tls_profile":                 v.TlsProfile,
			"yang_models":                 v.YangModels,
		})
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.GnmiServer.Equal(other.GnmiServer) {
		return false
	}
	...
	if !v.MaxConcurrentStreams.Equal(other.MaxConcurrentStreams) {
		return false
	}

	if !v.MetadataAuthentication.Equal(other.MetadataAuthentication) {
		return false
	}
	...
	if !v.RateLimitCallsPerMinute.Equal(other.RateLimitCallsPerMinute) {
		return false
	}
	...
	if !v.SessionLimit.Equal(other.SessionLimit) {
		return false
	}

	if !v.TlsProfile.Equal(other.TlsProfile) {
		return false
	}

	if !v.YangModels.Equal(other.YangModels) {
		return false
	}
...
var _ basetypes.ObjectTypable = GnmiServerType{}

type GnmiServerType struct {
	basetypes.ObjectType
}

func (t GnmiServerType) Equal(o attr.Type) bool {
	other, ok := o.(GnmiServerType)
...
func (t GnmiServerType) String() string {
	return "GnmiServerType"
}

func (t GnmiServerType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	var diags diag.Diagnostics

	attributes := in.Attributes()

	autoSaveAttribute, ok := attributes["auto_save"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`auto_save is missing from object`)

		return nil, diags
	}

	autoSaveVal, ok := autoSaveAttribute.(basetypes.BoolValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`auto_save expected to be basetypes.BoolValue, was: %T`, autoSaveAttribute))
	}
	...
	return GnmiServerValue{
		AutoSave: autoSaveVal,
		state:    attr.ValueStateKnown,
	}, diags
}

func NewGnmiServerValueNull() GnmiServerValue {
	return GnmiServerValue{
		state: attr.ValueStateNull,
	}
}

func NewGnmiServerValueUnknown() GnmiServerValue {
	return GnmiServerValue{
		state: attr.ValueStateUnknown,
	}
}

func NewGnmiServerValue(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) (GnmiServerValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	for name, attributeType := range attributeTypes {
		...
		if !ok {
			diags.AddError(
				"Missing GnmiServerValue Attribute Value",
				"While creating a GnmiServerValue value, a missing attribute value was detected. "+
					"A GnmiServerValue must contain values for all attributes, even if null or unknown. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("GnmiServerValue Attribute Name (%s) Expected Type: %s", name, attributeType.String()),
			)
		...
		if !attributeType.Equal(attribute.Type(ctx)) {
			diags.AddError(
				"Invalid GnmiServerValue Attribute Type",
				"While creating a GnmiServerValue value, an invalid attribute value was detected. "+
					"A GnmiServerValue must use a matching attribute type for the value. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("GnmiServerValue Attribute Name (%s) Expected Type: %s\n", name, attributeType.String())+
					fmt.Sprintf("GnmiServerValue Attribute Name (%s) Given Type: %s", name, attribute.Type(ctx)),
			)
		}
	}
	...
	for name := range attributes {
		...
		if !ok {
			diags.AddError(
				"Extra GnmiServerValue Attribute Value",
				"While creating a GnmiServerValue value, an extra attribute value was detected. "+
					"A GnmiServerValue must not contain values beyond the expected attribute types. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("Extra GnmiServerValue Attribute Name: %s", name),
			)
		}
	}

	if diags.HasError() {
		return NewGnmiServerValueUnknown(), diags
	}
...
func NewGnmiServerValueMust(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) GnmiServerValue {
	object, diags := NewGnmiServerValue(attributeTypes, attributes)
	...
	if diags.HasError() {
		...
		panic("NewGnmiServerValueMust received error(s): " + strings.Join(diagsStrings, "\n"))
	}

	return object
}

func (t GnmiServerType) ValueFromTerraform(ctx context.Context, in tftypes.Value) (attr.Value, error) {
	if in.Type() == nil {
		return NewGnmiServerValueNull(), nil
	}
	...
	if !in.IsKnown() {
		return NewGnmiServerValueUnknown(), nil
	}
	...
	return NewGnmiServerValueMust(GnmiServerValue{}.AttributeTypes(ctx), attributes), nil
}

func (t GnmiServerType) ValueType(ctx context.Context) attr.Value {
	return GnmiServerValue{}
}

var _ basetypes.ObjectValuable = GnmiServerValue{}

type GnmiServerValue struct {
	AutoSave basetypes.BoolValue `tfsdk:"auto_save"`
	state    attr.ValueState
}

func (v GnmiServerValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	attrTypes := make(map[string]tftypes.Type, 1)

	var val tftypes.Value
	var err error

	attrTypes["auto_save"] = basetypes.BoolType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.AutoSave.ToTerraformValue(ctx)
...
func (v GnmiServerValue) IsNull() bool {
	return v.state == attr.ValueStateNull
}

func (v GnmiServerValue) IsUnknown() bool {
	return v.state == attr.ValueStateUnknown
}

func (v GnmiServerValue) String() string {
	return "GnmiServerValue"
}

func (v GnmiServerValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	var diags diag.Diagnostics

	attributeTypes := map[string]attr.Type{
		"auto_save": basetypes.BoolType{},
	}
	...
	objVal, diags := types.ObjectValue(
		attributeTypes,
		map[string]attr.Value{
			"auto_save": v.AutoSave,
		})

	return objVal, diags
}

func (v GnmiServerValue) Equal(o attr.Value) bool {
	other, ok := o.(GnmiServerValue)
	...
	if !v.AutoSave.Equal(other.AutoSave) {
		return false
	}
...
func (v GnmiServerValue) Type(ctx context.Context) attr.Type {
	return GnmiServerType{
		basetypes.ObjectType{
			AttrTypes: v.AttributeTypes(ctx),
		},
...
func (v GnmiServerValue) AttributeTypes(ctx context.Context) map[string]attr.Type {
	return map[string]attr.Type{
		"auto_save": basetypes.BoolType{},
	}
}
